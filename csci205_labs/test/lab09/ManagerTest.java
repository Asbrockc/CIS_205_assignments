...

{
    ...
    {
        this.manager = new Manager(0, "Mr", "Crabs", 1112220000, HRDateUtils.strToDate("1800-12-3") ,0.49, "HR" );
        employees = new ArrayList<>(
                Arrays.asList(
                        ...
                        new Employee(1, "Spongebob", "Squarepants", 1322229999, HRDateUtils.strToDate("1933-02-01"),0.49 ),
                        new Employee(10, "Patric", "Star", 1651002000, HRDateUtils.strToDate("1999-07-19"),0.01 ),
                        new Employee(2, "Squidward", "Tentacles", 133203000, HRDateUtils.strToDate("1100-05-04"),0.48 )
                ));
    }
